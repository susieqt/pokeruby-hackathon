const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_POOCHYENA] = _("STRAY DOG"),
    [SPECIES_MIGHTYENA] = _("WOLF"),
    [SPECIES_ZIGZAGOON] = _("PSYCHO CAR"),
    [SPECIES_LINOONE] = _("MAD TRUCK"),
